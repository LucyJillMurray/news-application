...
class AuthenticationAccessTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.approved_url = reverse("news:api_view_approved_articles")
        self.create_url = reverse("news:api_article_create")

    def test_unauthenticated_request_is_rejected(self):
        # No credentials -> DRF returns 401 (BasicAuthentication) or 403
...
class JournalistCreateAPITests(APITestCase):
    ...
    def setUp(self):
        self.journo_user, self.journalist = make_journalist()
        self.url = reverse("news:api_article_create")
...
class SingleArticleAPITests(APITestCase):
    ...
    def test_approved_article_is_returned(self):
        ...
        url = reverse("news:api_view_article", args=[article.id])
...
class JournalistUpdateDeleteAPITests(APITestCase):
    ...
    def test_owner_can_update_and_it_unapproves(self):
        ...
        url = reverse("news:api_article_update", args=[self.article.id])
    ...
    def test_owner_can_delete(self):
        self.client.force_authenticate(user=self.owner_user)
        url = reverse("news:api_article_delete", args=[self.article.id])
...
class ApprovedArticlesIntegrationTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse("news:api_view_approved_articles")
